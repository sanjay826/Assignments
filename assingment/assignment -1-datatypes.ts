...
console.log(`Whether a customer has placed an order: ${ordered}`);
...
let employeesNumber : number = 500;
console.log(`Number of employees in a company: ${employeesNumber}`);

// 16.Time of an event: 2:30 PM
let enevntTime : string = "2:30 PM";
console.log(`Time of an event: ${enevntTime}`);
